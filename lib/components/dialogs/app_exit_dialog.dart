...
class _DialogView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: white, borderRadius: DIALOG_RADIUS, boxShadow: [SHADOW_2]),
  ...
  Widget _screenView(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text('Exit Skantrix?', textAlign: TextAlign.center, style: TextStyles.text22_600.copyWith(color: dark)),
